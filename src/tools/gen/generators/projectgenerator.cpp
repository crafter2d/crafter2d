...
namespace c2d::gen
{
   GENERATOR_IMPL(ProjectGenerator);
   ...
   UChar ProjectGenerator::getBriefCommand() const
   {
      return L'p';
   }

   const String& ProjectGenerator::getCommand() const
   {
      static const String sCommand(UTEXT("project"));
      return sCommand;
   }
