...
#include "E:/Devel/jenginesse/src/unittest/testbufferedstream.h"

static TestBufferedStream suite_TestBufferedStream;

static CxxTest::List Tests_TestBufferedStream = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestBufferedStream( "E:/Devel/jenginesse/src/unittest/testbufferedstream.h", 9, "TestBufferedStream", suite_TestBufferedStream, Tests_TestBufferedStream );
...
#include "E:/Devel/jenginesse/src/unittest/testcommandline.h"

static TestCommandLine suite_TestCommandLine;

static CxxTest::List Tests_TestCommandLine = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestCommandLine( "E:/Devel/jenginesse/src/unittest/testcommandline.h", 10, "TestCommandLine", suite_TestCommandLine, Tests_TestCommandLine );
...
#include "E:/Devel/jenginesse/src/unittest/testcompiler.h"
...
#include "E:/Devel/jenginesse/src/unittest/testhashmap.h"

static TestHashMap suite_TestHashMap;

static CxxTest::List Tests_TestHashMap = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestHashMap( "E:/Devel/jenginesse/src/unittest/testhashmap.h", 14, "TestHashMap", suite_TestHashMap, Tests_TestHashMap );
...
#include "E:/Devel/jenginesse/src/unittest/testlist.h"

static TestList suite_TestList;

static CxxTest::List Tests_TestList = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestList( "E:/Devel/jenginesse/src/unittest/testlist.h", 9, "TestList", suite_TestList, Tests_TestList );
...
#include "E:/Devel/jenginesse/src/unittest/testvariant.h"

static TestVariant suite_TestVariant;

static CxxTest::List Tests_TestVariant = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestVariant( "E:/Devel/jenginesse/src/unittest/testvariant.h", 11, "TestVariant", suite_TestVariant, Tests_TestVariant );
...
#include "E:/Devel/jenginesse/src/unittest/testvirtualmachine.h"
