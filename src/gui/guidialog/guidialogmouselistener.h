 ...
 ***************************************************************************/
#ifndef GUIDIALOG_MOUSE_LISTENER_H
#define GUIDIALOG_MOUSE_LISTENER_H

#include "gui/input/mouselistener.h"

class GuiDialog;

class GuiDialogMouseListener : public MouseListener
{
public:
   GuiDialogMouseListener(GuiDialog& dialog);
