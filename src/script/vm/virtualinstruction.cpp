...
const std::string& VirtualInstruction::instructionToString(Instruction inst)
{
   switch ( inst )
   {
      ...
      case eCmpEqual:      return sCmpEqual;
      case eCmpNotEqual:   return sCmpNotEqual;
      case eCmpSEqual:     return sCmpSEqual;
      case eCmpSmaller:    return sCmpSmaller;
      case eCmpGreater:    return sCmpGreater;
      case eCmpGEqual:     return sCmpGEqual;
